...
| **Growth stores that ship** | `KNOWLEDGE.md` 186 entries, `KNOWHOW.md` 40, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 27 papers |
...
| **Tests** | 2,117, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 186 entries |
