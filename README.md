...
| **Growth stores that ship** | `KNOWLEDGE.md` 213 entries, `KNOWHOW.md` 44, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 28 papers |
...
| **Tests** | 2,238, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 213 entries |
