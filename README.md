...
| **Growth stores that ship** | `KNOWLEDGE.md` 178 entries, `KNOWHOW.md` 39, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 24 papers |
...
| **Tests** | 2,068, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 178 entries |
