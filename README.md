...
| **Growth stores that ship** | `KNOWLEDGE.md` 150 entries, `KNOWHOW.md` 39, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 24 papers |
...
| **Tests** | 1,608, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 150 entries |
