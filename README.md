...
| **Growth stores that ship** | `KNOWLEDGE.md` 189 entries, `KNOWHOW.md` 42, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 27 papers |
...
| **Tests** | 2,124, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 189 entries |
