...
| **Growth stores that ship** | `KNOWLEDGE.md` 217 entries, `KNOWHOW.md` 44, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 28 papers |
...
| **Tests** | 2,263, stdlib only, run in CI |
