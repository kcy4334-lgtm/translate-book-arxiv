...
| **Growth stores that ship** | `KNOWLEDGE.md` 180 entries, `KNOWHOW.md` 39, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 25 papers |
...
| **Tests** | 2,084, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 180 entries |
...
| `corpus/shapes.json` | Every LaTeX construct each paper carried, written by the build itself. 25 papers |
