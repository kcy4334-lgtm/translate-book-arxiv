...
| **Growth stores that ship** | `KNOWLEDGE.md` 181 entries, `KNOWHOW.md` 39, `REFEREE.md` 6, and a census of every LaTeX shape the corpus has met across 26 papers |
...
| **Tests** | 2,096, stdlib only, run in CI |
...
| | what it holds |
|---|---|
| `KNOWLEDGE.md` | What a tool actually did, with the measurement that proved it. 181 entries |
